...
public class ServerHandler extends ChannelInboundHandlerAdapter {
    ...
    private ChannelHandlerContext clientB;

    public ServerHandler(TCPServer backwardSrv) {
    ...
    public void channelRead(ChannelHandlerContext channelHandlerContext, Object info) throws Exception {
        System.out.println("接收到了客户端数据：" + info);
...
//        }
    ...
    public void  sendMsg(Object info) {
        if ( this.clientB != null)  {
            this.clientB.channel().writeAndFlush(info);
        }
    }
